...
let { radius, maxSpeed, initSpeed, direction } = {
    // radius: window.innerWidth / 5 || 200 as number,
    radius: window.innerWidth / 3.5 as number,
    maxSpeed: 20 as number,
    initSpeed: 30 as number,
